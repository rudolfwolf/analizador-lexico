/*
    ...
    14/11/22
    Practica de Analisis Lexico final
*/
...
int main(){
	...
	if(remove("Codigo_Objeto.txt")==0) 
        printf("Archivo Codigo_Objeto.txt reescrito \n");
    else
        printf("Creando archivo de salida Codigo_Objeto.txt\n");
        Sleep(20);
	
	ofstream objeto;
	string NombreObjeto="Codigo_Objeto.txt";
	objeto.open(NombreObjeto.c_str(),ios::out);
